                            ...
                            <div key={card?.id} className="bg-dark p-5 rounded-3xl hover:bg-primary duration-300 hover:text-dark group hover:rotate-3">
                                <div className="flex justify-between">
                                    ...
                                    <button className="flex items-center gap-2">
                                        <Image src={arrowLightIcon} className="group-hover:hidden w-6 rotate-180" alt="arrow" />
                                        <Image src={arrowIcon} className="hidden group-hover:inline-block w-6" alt="arrow" />
